...
- **Name:** `DATABASE_URL`
- **Value:** `postgresql://postgres:YOUR_PASSWORD@/crossify-db?host=/cloudsql/YOUR_PROJECT_ID:YOUR_REGION:crossify-db`
...
PORT=3001
NODE_ENV=production
DATABASE_URL=postgresql://postgres:YOUR_PASSWORD@/crossify-db?host=/cloudsql/YOUR_PROJECT_ID:YOUR_REGION:crossify-db
BASE_RPC_URL=https://base-sepolia.publicnode.com
BSC_RPC_URL=https://bsc-testnet.publicnode.com
ETHEREUM_RPC_URL=https://ethereum-sepolia-rpc.publicnode.com
CLOUDINARY_API_KEY=YOUR_CLOUDINARY_API_KEY
...
SOLANA_RPC_URL=https://api.mainnet-beta.solana.com
WALLETCONNECT_PROJECT_ID=YOUR_WALLETCONNECT_PROJECT_ID
BASE_FACTORY=YOUR_BASE_FACTORY_ADDRESS
BSC_FACTORY=YOUR_BSC_FACTORY_ADDRESS
ETH_FACTORY=YOUR_ETH_FACTORY_ADDRESS
